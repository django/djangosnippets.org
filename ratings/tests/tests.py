...
class RatingsTestCase(TestCase):
    ...
    def test_order_postgresql(self):
        ...
        self.assertEqual(list(rated_qs), list(self.rated_model.ratings.order_by_rating()))
        ...
        item13_qs = self.rated_model._default_manager.filter(pk__in=[self.item1.pk, self.item3.pk])
...
class RecommendationsTestCase(TestCase):
    ...
    def test_matching(self):
        ...
        expected = [
            (0.99124070716192991, self.user_a),
