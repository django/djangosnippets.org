...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.django_version'
        db.add_column('cab_snippet', 'django_version', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Snippet.django_version'
        db.delete_column('cab_snippet', 'django_version')
